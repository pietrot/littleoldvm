...
sudo add-apt-repository -y ppa:ondrej/php # Most requested extensions (supports php 7.0).
...
apt-get install -y mod_proxy proxy mod_proxy_fcgi
...
# Install extensions.
apt-get install -y php7.0-cli php7.0-common php7.0-curl php7.0-gd php7.0-intl php7.0-json php7.0-mcrypt php-memcached php7.0-xmlrpc php7.0-zip php7.0-mbstring php7.0-xml php7.0-mysql
